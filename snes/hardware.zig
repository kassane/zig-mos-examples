...
pub fn DMAP(comptime n: u3) *volatile u8 { return reg(0x4300 + @as(u16, n) * 0x10); }
pub fn BBAD(comptime n: u3) *volatile u8 { return reg(0x4301 + @as(u16, n) * 0x10); }
pub fn A1TL(comptime n: u3) *volatile u8 { return reg(0x4302 + @as(u16, n) * 0x10); }
pub fn A1TH(comptime n: u3) *volatile u8 { return reg(0x4303 + @as(u16, n) * 0x10); }
pub fn A1B(comptime n: u3)  *volatile u8 { return reg(0x4304 + @as(u16, n) * 0x10); }
pub fn DASL(comptime n: u3) *volatile u8 { return reg(0x4305 + @as(u16, n) * 0x10); }
pub fn DASH(comptime n: u3) *volatile u8 { return reg(0x4306 + @as(u16, n) * 0x10); }
